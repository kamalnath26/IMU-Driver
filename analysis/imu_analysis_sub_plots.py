...
def plot_data(time_stamps, gyro_x_deg, gyro_y_deg, gyro_z_deg, accel_x, accel_y, accel_z, yaw, pitch, roll):
    ...
    plt.title('Gyroscope Data all XYZ in same plot')
    plt.legend()
    plt.grid(True)
    plt.tight_layout()
    
    plt.subplot(4, 1, 2)
    plt.plot(time_stamps - time_stamps[0], gyro_x_deg, label='Gyro X (deg/s)', marker='o', color='red')
    plt.xlabel('Time (s)')
    plt.ylabel('Gyro Rate (degrees/s)')
    plt.title('Gyroscope Data X')
    plt.legend()
    plt.grid(True)
    plt.tight_layout()
    ...
    # plt.figure()
    plt.subplot(4, 1, 3)
    plt.plot(time_stamps - time_stamps[0], gyro_y_deg, label='Gyro Y (deg/s)', marker='x', color='blue')
    plt.xlabel('Time (s)')
    plt.ylabel('Gyro Rate (degrees/s)')
    plt.title('Gyroscope Data Y')
    plt.legend()
    plt.grid(True)
    plt.tight_layout()
    ...
    # plt.figure()
    plt.subplot(4, 1, 4)
    plt.plot(time_stamps - time_stamps[0], gyro_z_deg, label='Gyro Z (deg/s)', marker='^', color='green')
    plt.xlabel('Time (s)')
    plt.ylabel('Gyro Rate (degrees/s)')
    plt.title('Gyroscope Data Z')
    plt.legend()
    plt.grid(True)
    plt.tight_layout()
    ...
    plt.title('Accelerometer Data XYZ in same plot')
    plt.legend()
    plt.grid(True)
    plt.tight_layout()
    
    plt.subplot(4, 1, 2)
    plt.plot(time_stamps - time_stamps[0], accel_x, label='Accel X (m/s^2)', marker='o', color='red')
    plt.xlabel('Time (s)')
    plt.ylabel('Acceleration (m/s^2)')
    ...
    plt.subplot(4, 1, 3)
    plt.plot(time_stamps - time_stamps[0], accel_y, label='Accel Y (m/s^2)', marker='x', color='blue')
    plt.xlabel('Time (s)')
    plt.ylabel('Acceleration (m/s^2)')
    plt.title('Accelerometer Data Y')
    plt.legend()
    plt.grid(True)
    plt.tight_layout()
    
    plt.subplot(4, 1, 4)
    plt.plot(time_stamps - time_stamps[0], accel_z, label='Accel Z (m/s^2)', marker='^', color='green')
    plt.xlabel('Time (s)')
    plt.ylabel('Acceleration (m/s^2)')
    plt.title('Accelerometer Data Z')
    plt.legend()
    plt.grid(True)
    plt.tight_layout()
    ...
    plt.figure()
    plt.subplot(4, 1, 1)
    plt.plot(time_stamps - time_stamps[0], yaw, label='Yaw (deg)', marker='o', color='red')
    ...
    plt.title('Rotation from VN Estimation XYZ in same plot')
    plt.legend()
    plt.grid(True)
    plt.tight_layout()
    ...
    plt.xlabel('Time (s)')
    plt.ylabel('Rotation (degrees)')
    plt.title('Rotation from VN Estimation X')
    plt.legend()
    plt.grid(True)
    plt.tight_layout()
    
    plt.subplot(4, 1, 3)
    plt.plot(time_stamps - time_stamps[0], pitch, label='Pitch (deg)', marker='x',color='blue')
    plt.xlabel('Time (s)')
    plt.ylabel('Rotation (degrees)')
    plt.title('Rotation from VN Estimation Y')
    plt.legend()
    plt.grid(True)
    plt.tight_layout()
    
    plt.subplot(4, 1, 4)
    plt.plot(time_stamps - time_stamps[0], roll, label='Roll (deg)', marker='^', color='green')
    plt.xlabel('Time (s)')
    plt.ylabel('Rotation (degrees)')
    plt.title('Rotation from VN Estimation Z')
    plt.legend()
    plt.grid(True)
    plt.tight_layout()
    ...
    plt.title('Histogram of Rotation XYZ in same plot')
    plt.grid(True)
    plt.tight_layout()
